...
case class FilterRegistration(queryId: Int, filters: Seq[FilterTriple])
case class FilterRequest(query: Array[Int], var destination: Long)
case class FilterResponse(query: Array[Int])
